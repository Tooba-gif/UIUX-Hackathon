...
import profil from "@/app/public/Profil.jpeg";
import Settings from "@/app/public/Settings.jpeg";
import Like from"@/app/public/Like.jpeg";
...
<header className='flex shadow-md sm:px-10 px-6 py-3 bg-white font-[sans-serif] min-h-[70px]'>
      <div className="flex w-full max-w-screen-xl mx-auto">
        <div
          ...
          <div className="flex">
           <p className="logo"w-20 h-10 ml-16 gap-0 opacity-0 text-3xl font-bold text-left > MORENT
           </p>
          </div>
          ...
          <div
            ...
            <input type='email' placeholder='Search something here' className="w-full outline-none bg-transparent text-black text-sm" />
          </div>
          ...
          <div className='flex items-center space-x-4 max-md:ml-auto'>
            <button type="button" className="border-none outline-none flex items-center justify-center rounded-full p-2 hover:bg-gray-100 transition-all">
             <Image src={Like} alt="sidepic"></Image>
            ...
            <button type="button" className="border-none outline-none flex items-center justify-center rounded-full p-2 hover:bg-gray-100 transition-all">
              <Image src={Settings} alt="sidepic"></Image>
              {/* <svg xmlns= "http://www.w3.org/2000/svg" className="w-5 h-5 cursor-pointer fill-black"
                viewBox="0 0 512 512">
                <path
            ...
            <button type="button" className="border-none outline-none flex items-center justify-center rounded-full p-2 hover:bg-gray-100 transition-all">
              <Image src={profil} alt="sidepic"></Image>
            </button>
          </div>
        </div>
